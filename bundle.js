        ...
        value: function start(cb) {
            ...
            if (this.cbs.length == 0) {
                this.interval = setInterval(function () {
                    _this.cbs.forEach(function (cb1) {
                        if (cb1()) {
                            _this.cbs = _this.cbs.filter(function (cb2) {
                                return cb1 != cb2;
                            });
                            console.log(_this.cbs);
...
var animQueue = new AnimQueue();
exports.animQueue = animQueue;
...
var LineComponent = function (_Component) {
    _inherits(LineComponent, _Component);

    function LineComponent(props) {
        _classCallCheck(this, LineComponent);

        var _this = _possibleConstructorReturn(this, (LineComponent.__proto__ || Object.getPrototypeOf(LineComponent)).call(this, props));

        _this.state = { x: w / 2 - size, y: h / 2 - size, size: 2 * size };
        return _this;
    }
    ...
    _createClass(LineComponent, [{
        ...
        value: function componentDidMount() {
            ...
            window.onresize = function () {
                var newSize = Math.min(w, h) / 3;
                _this2.setState({ x: w / 2 - newSize, size: 2 * newSize });
            };
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement('div', { style: { position: 'absolute', left: this.state.x, top: h / 2,
...
var _StateObject2 = _interopRequireDefault(_StateObject);

var _AnimQueue = require('./AnimQueue');
...
var PlusMinusComponent = function (_Component) {
    _inherits(PlusMinusComponent, _Component);

    function PlusMinusComponent() {
        _classCallCheck(this, PlusMinusComponent);

        var _this = _possibleConstructorReturn(this, (PlusMinusComponent.__proto__ || Object.getPrototypeOf(PlusMinusComponent)).call(this));

        _this.stateObj = new _StateObject2.default();
        _this.state = { rot: 90 };
        return _this;
    }

    _createClass(PlusMinusComponent, [{
        key: 'startAnim',
        value: function startAnim() {
            var _this2 = this;

            this.stateObj.startUpdating(function () {
                _AnimQueue.animQueue.start(function () {
                    return _this2.stateObj.update(function (sc) {
                        var rot = 90 * (1 - sc);
                        _this2.setState({ rot: rot });
                    });
                });
            });
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { onClick: this.startAnim.bind(this) },
                [0, 1].map(function (num) {
                    return _react2.default.createElement(_LineComponent2.default, { key: 'line_' + num, i: num, rot: _this3.state.rot });
                })
            );
        }
    }]);
...
exports.default = PlusMinusComponent;

},{"./AnimQueue":1,"./LineComponent":2,"./StateObject":4,"react":29}],4:[function(require,module,exports){
"use strict";
...
var StateObject = function () {
    ...
    _createClass(StateObject, [{
        key: "update",
        value: function update(updatecb) {
...
var _PlusMinusComponent = require('./PlusMinusComponent');

var _PlusMinusComponent2 = _interopRequireDefault(_PlusMinusComponent);
...
var PlusMinusComponentDemo = function (_Component) {
    _inherits(PlusMinusComponentDemo, _Component);

    function PlusMinusComponentDemo() {
        _classCallCheck(this, PlusMinusComponentDemo);

        return _possibleConstructorReturn(this, (PlusMinusComponentDemo.__proto__ || Object.getPrototypeOf(PlusMinusComponentDemo)).call(this));
    }

    _createClass(PlusMinusComponentDemo, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { style: { width: "100%", height: "100%", backgroundColor: "#BDBDBD" } },
                _react2.default.createElement(_PlusMinusComponent2.default, null)
            );
        }
    }]);

    return PlusMinusComponentDemo;
}(_react.Component);

_reactDom2.default.render(_react2.default.createElement(PlusMinusComponentDemo, null), document.getElementById('container'));

},{"./PlusMinusComponent":3,"react":29,"react-dom":26}],6:[function(require,module,exports){
/**
...
},{"./cjs/react.development.js":27,"./cjs/react.production.min.js":28,"_process":21}]},{},[5]);
